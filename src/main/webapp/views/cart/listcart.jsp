...
<link rel="stylesheet" href="http://localhost:8080/Nhom11/views/cart/style.css">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="cart_container">
                        ...
                        <div>
                            ...
                            <input name="address" type="text" id="address" placeholder="Nhập địa chỉ" class="address_input">
                            <br> <br>
                            <label for="phonenumber">Số điện thoại :</label> 
                            <input name="phonenumber" type="text" id="address" placeholder="Nhập số điện thoại" class="address_input">
                            <div class="cart_buttons">
                                <a href="/Nhom11/home" class="button cart_button_clear">Tiếp tục mua sắm</a>
